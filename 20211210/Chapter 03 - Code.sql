...
-- regular character string (mal, conversión implicita de tipos)
...
-- NULLs sort first
-- Up to implementation, no SQL standard defined (use NULLS FIRST / NULL LAST)
